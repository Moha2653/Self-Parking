...
for row in range(6):
    ...
    # Vertical lines (The limit of the aisle)
...
while running:
    ...
    # Draw The Grid Lines (White Paint)
...
if result_msg:
    ...
    s.fill((0,0,0,180))
    screen.blit(s, (0,0))
    msg = pygame.font.SysFont("Arial", 42, bold=True).render(result_msg, True, (255, 255, 255))
